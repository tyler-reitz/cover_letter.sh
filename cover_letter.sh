...
LETTER="Hello $ADDRESSEE,

I’m an experienced Full-Stack Javascript Developer based in DTLA who's worked with the lowliest-of-startups on up to the top of the Fortune 500 (and everywhere in between).
...
I’m reaching out to you today on $LISTING because I think $COMPANY's core mission aligns perfectly with my technical prowess and professional interests.
